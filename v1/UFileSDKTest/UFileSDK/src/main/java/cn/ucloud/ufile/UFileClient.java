...
public class UFileClient {
    ...
    private UFileConfig uFileConfig;


    public UFileClient(UFileConfig uFileConfig) {
        httpClient = new DefaultHttpClient();
        this.setHttpClient(httpClient);
        this.uFileConfig = uFileConfig;
    }

    public void makeAuth(String stringToSign, UFileRequest request) {
        String signature = new HmacSHA1().sign(uFileConfig.getUcloudPrivateKey(), stringToSign);
        String authorization = "UCloud" + " " + uFileConfig.getUcloudPublicKey() + ":" + signature;
    ...
    public UFileConfig getUFileConfig() {
        return uFileConfig;
    }
}
