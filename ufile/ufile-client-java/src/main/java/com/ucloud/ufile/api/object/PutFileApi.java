...
import com.ucloud.ufile.bean.PutObjectResultBean;
import com.ucloud.ufile.bean.UfileErrorBean;
import com.ucloud.ufile.exception.UfileFileException;
...
import com.ucloud.ufile.http.request.PutFileRequestBuilder;
...
public class PutFileApi extends UfileObjectApi<PutObjectResultBean> {
    ...
    protected void prepareData() throws UfileException {
        try {
            ...
            String authorization = authorizer.authorization(HttpMethod.PUT, bucketName, keyName,
                    contentType, contentMD5, date);
